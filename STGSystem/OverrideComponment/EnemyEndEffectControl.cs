...
{
	// 敌机击破效果控制系统
	public class EnemyEndEffectControl : EffectControl
	{
		...
		public override void Init()
		{
			...
			foreach (ParticleSystem particleSystem in ParticleSystems)
			{
				...
				{
					Debug.LogWarning("EnemyEndEffectControl: ParticleSystem is null."); // 如果粒子系统为空，则输出警告信息
		...
		public void Play()
		{
			...
			{
				Debug.LogError("EnemyEndEffectControl: ParticleSystem is not assigned or found."); // 如果粒子系统未分配，则输出错误信息
			}
